...
class Site(Base):
    ...
    mien                  = Column(String(10), nullable=True) # Allowed Null
    tinh                  = Column(String(100), nullable=True) # Allowed Null
    phuong_xa             = Column(String(150))
    site_name_cu          = Column(String(100))
    site_name             = Column(String(100), nullable=False, unique=True, index=True) # Required
    site_vip              = Column(String(10))
    lat                   = Column(Float, nullable=True) # Changed from False to True
    long                  = Column(Float, nullable=True) # Changed from False to True
    ...
    ma_ptm                = Column(String(100), nullable=True) # Changed from False to True
